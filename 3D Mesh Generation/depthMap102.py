...
rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(image_o3d, depth_o3d, convert_rgb_to_intensity=True)
...
# save the mesh
o3d.io.write_triangle_mesh(f'./mesh2.obj', mesh)
